    ...
    <div class="kt-container-fixed flex justify-between items-stretch lg:gap-4" id="headerContainer">
        ...
        <div class="flex gap-2.5 lg:hidden items-center -ms-1">
            <a class="shrink-0" href="html/demo1.html">
                <img class="max-h-[25px] w-full" src="{{ asset('admin_assets/media/app/mini-logo.svg') }}" />
            </a>
        ...
        <!--Megamenu Contaoner-->
        <x-dashboard.organization.layout.includes.megamenu />
        <!--End of Megamenu Contaoner-->
        
        <!-- Topbar -->
        <x-dashboard.organization.layout.includes.topbar />
        <!-- End of Topbar -->
