...
<head>
    ...
    <x-dashboard.organization.layout.includes.styles />
    {{ $styles ?? '' }}
</head>

<body class="antialiased flex h-full text-base text-foreground bg-background demo1 kt-sidebar-fixed kt-header-fixed">
    <!-- Theme Mode -->
    <x-dashboard.organization.layout.includes.default-theme-mode />
    <!-- End of Theme Mode -->
    <!-- Page -->
    <!-- Main -->
    <div class="flex grow">

        <x-dashboard.organization.layout.includes.sidebar />

        <x-dashboard.organization.layout.includes.session />

        <!-- Wrapper -->
        <div class="kt-wrapper flex grow flex-col">

            <!-- Header -->
            <x-dashboard.organization.layout.includes.header />
            <!-- End of Header -->
            ...
            <!-- End of Content -->
            <!-- Footer -->
            <x-dashboard.organization.layout.includes.footer />
            <!-- End of Footer -->
        </div>
        <!-- End of Wrapper -->
    </div>
    ...
    <x-dashboard.organization.layout.includes.scripts />
