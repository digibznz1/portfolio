<x-dashboard.admin.layout.app>
	...
	<x-slot name="title">{{ trans('admin.models.admins') . ' - ' . trans('admin.models.evaluations') . ' - ' . trans('admin.evaluations.self_evaluations.model') }}</x-slot>	
	...
	<div class="flex flex-wrap items-center lg:items-end justify-between gap-5 py-3.5">
		...
		<div class="flex items-center gap-3">
			...
			<x-dashboard.admin.button.add permission="create-self_evaluations"/>

			<x-dashboard.admin.button.bulk-delete permission="delete-self_evaluations"/>
			...
			<div class="flex-wrap gap-2 mb-2.5">
				...
				<div class="flex flex-wrap gap-2 lg:gap-5">
					...
					<x-dashboard.admin.data-table.filter>
						...
						<x-input.option name="organization_type" :all='true' :choose='false' class="w-36" id="select-organization-type" :lists="$organizationTypes"/>
	...
	<x-slot name="scripts">
		...
		<script>
			$('#select-organization-type').on('change', function () {
				Table.draw();
			});
		</script>
