<x-dashboard.admin.layout.app>
	...
	<x-slot name="title">{{ trans('admin.models.admins') . ' - ' . trans('admin.models.evaluations') . ' - ' . trans('admin.evaluations.self_evaluation_files.model') }}</x-slot>	
	
	<h1 class="text-lg font-semibold mb-2">{{ trans('admin.evaluations.self_evaluation_files.model') }}</h1>
	...
	<div class="flex flex-wrap items-center lg:items-end justify-between gap-5 py-3.5">
		...
		<div class="flex items-center gap-3">
			...
			<x-dashboard.admin.button.add permission="create-self_evaluation_files" :prams="[$selfEvaluation->id]"/>

			<x-dashboard.admin.button.bulk-delete permission="delete-self_evaluation_files" :prams="[$selfEvaluation->id]"/>
