<x-dashboard.admin.layout.app>
	...
	<x-slot name="title">{{ trans('admin.models.admins') . ' - ' . trans('admin.models.evaluations') . ' - ' . trans('admin.evaluations.initial_evaluations.model') }}</x-slot>	
	...
	<div class="flex flex-wrap items-center lg:items-end justify-between gap-5 py-3.5">
		...
		<div class="flex items-center gap-3">
			...
			<x-dashboard.admin.button.add permission="create-initial_evaluations"/>

			<x-dashboard.admin.button.bulk-delete permission="delete-initial_evaluations"/>
