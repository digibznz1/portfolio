<x-dashboard.admin.layout.app>
    ...
    <x-slot name="title">{{ trans('admin.models.websites') . ' - ' . trans('admin.models.team') }}</x-slot>
    ...
    <div class="flex flex-wrap items-center lg:items-end justify-between pt-3.5">
        <div class="flex items-center gap-3">
            <x-dashboard.admin.button.add permission="create-team"/>
            <x-dashboard.admin.button.bulk-delete permission="delete-team"/>
        </div>
    </div>
